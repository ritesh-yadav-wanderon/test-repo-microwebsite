          ...
          <div className="flex items-start space-x-6">
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a 
                  href="https://api.whatsapp.com/send?phone=919090403075&text=Hi%20WanderOn%2C%20I%20have%20a%20query%20about%20safe%20travel%20alternatives!"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-[#25D366] hover:bg-[#20BA5A] text-white px-8 py-3 rounded-full font-bold transition-all duration-300 flex items-center gap-2"
                >
                  <WhatsAppIcon />
                  Chat on WhatsApp
                </a>
