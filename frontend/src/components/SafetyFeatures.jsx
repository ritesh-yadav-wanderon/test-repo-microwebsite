...
import { ShieldCheck, Phone, Heart, Activity, Home, Users } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            We've implemented comprehensive safety measures to ensure every journey is secure, comfortable, and worry-free
          </p>
        </div>
        ...
        <div className="mt-16 text-center bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl p-12">
          <h3 className="text-2xl font-bold text-gray-900 mb-4">
            Still have questions about our safety measures?
          </h3>
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Our team is available 24/7 to address any concerns and provide detailed information about our protocols
          </p>
